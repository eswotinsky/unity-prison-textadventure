...
public class TextController : MonoBehaviour {
	...
	void lock_1 () {
		text.text = "You carefully put the mirror through the bars, and turn it around so you can see the lock. You can just make out fingerprints around the buttons. You press the dirty buttons, and hear a click.\n\n" +
	...
	void cell_mirror () {
		text.text = "You are still in your cell, and you STILL want to escape! There are some dirty sheets on the bed, a mark where the mirror was, and that pesky door is still there, firmly locked.\n\n" +
		"Press L to view lock.\n" + 
		"Press S to view sheets."; 
	...
	void corridor_0 () {
		text.text = "You're out of your cell, but not out of trouble. You find yourself in a corridor, with a closet and some stairs leading to the courtyard. There's also various detritus on the floor.\n\n" +
	...
	void stairs_0 () {
		text.text = "You start walking up the stairs towards the outside light. You realize it's not break time, and you'll be caught immediately. You slither back down the stairs and reconsider.\n\n" +
	...
	void stairs_1 () {
		text.text = "Unfortunately, wielding a puny hairclip hasn't given you the confidence to walk out into a courtyard surrounded by armed guards.\n\n" +
	...
	void stairs_2 () {
		text.text = "You feel smug for picking the closet door open, and are still armed with a hairclip (now badly bent). But even these achievements together don't give you the courage to climb up the stairs to your death.\n\n" +
		"Press R to return to the corridor.";
	...
	void courtyard () {
		text.text = "You walk through the courtyard dressed as a cleaner. The guard tips his hat at you as you waltz past, claiming your freedom. Your heart races as you walk into the sunset.\n\n" +
	...
	void closet_door () {
		text.text = "You're looking at a closet door. Unfortunately, it's locked. Maybe you could find something around here to help encourage it to open?\n\n" +
		"Press R to return to the corridor."; 
	...
	void in_closet () {
		text.text = "Inside the closet you see a cleaner's uniform that looks to be about your size! Seems like things are looking up.\n\n" +
		"Press D to dress up.\n" +
		"Press R to return to the corridor."; 
